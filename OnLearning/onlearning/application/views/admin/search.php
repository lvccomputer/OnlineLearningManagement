<div class="row">
    <div class="col-sm-4 class1">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("index.php/course/all/") ?>"><img src="<?php echo base_url("images/question.png"); ?>">&nbsp;&nbsp; Quản lý khóa học</a>
            </li>
            <li class="nav-item">
