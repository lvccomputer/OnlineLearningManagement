<div class="row">
    ...
    <div class="col-sm-6 class1">
        ...
        <?php foreach($quiz_list as $quiz): ?>
            <tr>
                <td><a href="<?php echo base_url("index.php/quiz/edit/".$quiz["id"]) ?>">
                    <?php echo $quiz['quiz_name'] ?>
                <td><a href="<?php echo base_url("index.php/quiz/edit/".$quiz["id"]) ?>"><img class="image1" src="<?php echo base_url("images/update.png"); ?>"></a></td>
                <td><a href="<?php echo base_url("index.php/quiz/delete/".$quiz["id"]) ?>"><img class="image1" src="<?php echo base_url("images/criss-cross.png"); ?>"></a></td>
            </tr>
        <?php endforeach ?>
        </table>
        <br>
    ...
    <div class="page">
        <ul class="pagination justify-content-center">
            <?php for($p = 1; $p <= ceil($total/5); $p++): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo base_url("index.php/quiz/index/".$p)?>"><?php echo $p ?></a>
                </li>
            <?php endfor ?>
        </ul>
    </div>  
